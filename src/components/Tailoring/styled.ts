...
export default {
  ...
  `,
    BoxContent: styled.div<ITailoringProps>`
    display: flex;
  ...
  `,
    BoxImage: styled.div<ITailoringProps>`
    display: flex;
    position: relative;
    width: 550px;
    height: 508px;
  ...
  `,
    BoxDescription: styled.div<ITailoringProps>`
    display: flex;
    flex: 1;
    padding-top: 60px;
    padding-bottom: 60px;
  ...
  `,
    BoxContainerLine: styled.div<ITailoringProps>`
    display: flex;
    flex: 1;
    max-width: 561px;
    flex-direction: column;
